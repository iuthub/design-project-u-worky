    ...
    <div class="row">
        ...
        <div class="col-md-7 col-7">
            ...
            <div class="row user-info">
                ...
                <div class="col-lg-6 col-md-12">
                    <i class="fas fa-phone green-text"></i><strong>Phone
                        :</strong><br><span>{{Auth::user()->number}}</span>
                </div>
                <div class="col-lg-6 col-md-12">
            ...
            <div class="row mb-3">
                <a type="button" class="btn btn-primary btn-rounded" href="{{route('admin.edit')}}"><i
