    ...
    <div class="row">
        ...
        <div class="job-detail-content">
            ...
            <div class="job-description">
                ...
                <p>
                Are you bored of carrying out the same daily project tasks & chores or feel that you have more to offer the world of enterprise web application development? If so, we want to hear from you!
            ...
            <div class="job-btn-wrapper">
                <button type="button" class="btn-print btn btn-md btn-rounded btn-white-border blue-text"><i class="ion-android-print pr-2"></i>Print</button>
                <button type="button" class="btn-show btn btn-md btn-rounded btn-white-border blue-text"><i class="ion-eye pr-2"></i>Show</button>
                <button type="button" class="btn-apply btn btn-md btn-rounded btn-white-border blue-text"><i class="ion-android-send pr-2"></i>Apply</button>
            </div>
            </div>
        </div>
