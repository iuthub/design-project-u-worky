                    ...
                    <div class="tab-pane fade in show active" id="recent-jobs-panel" role="tabpanel">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    @foreach ($recent_jobs as $item) <!-- Card -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span class="badge badge-pill pink"><a href="#">FULL -
                                                                    TIME</a></span>
                                                            <!-- /Category & Title -->
                                            ...
                                            <div class="card">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <div class="card-body">
                                                            <!-- Category & Title -->
                                                            <h5 class="card-title"><strong><a href="">Senior PHP Web
                                                                        Developer</a></strong></h5>
                                                            <span class="badge badge-pill pink"><a href="#">FULL -
                                                                    TIME</a></span>
                                                            <!-- /Category & Title -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p>
                                                            <i class="fa fas fa-suitcase pr-3 mb-1 blue-text"></i>Netco
                                                            Telecom<br>
                                                            <i
                                                                class="fas fa-map-marker-alt pr-3 mb-1 red-text"></i>Tashkent,
                                                            Mustakillik str. 5/1<br>
                                    ...
                                    <div class="col-lg-6 col-md-6 job">
                                        <div class="card">
                                            <div class="row">
                                                ...
                                                <div class="col-4 card-image-wrapper">
                                                    <div class="card-image">
                                                        <img src="{{asset('frontend/img/employer-logo-turon.png')}}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                                <!--Card image -->
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p>
                                                            <i class="fa fas fa-suitcase pr-3 mb-1 blue-text"></i>Turon
                                                            Telecom<br>
                                                            <i
                                                                class="fas fa-map-marker-alt pr-3 mb-1 red-text"></i>Tashkent,
                                                            Mustakillik str. 5/1<br>
                                                            <i class="fas fa-money-bill pr-3 mb-1 green-text"></i>$2,000
                                                            - $2,300<br>
                                                        </p>
                                                    </div>
                                                    <!-- /Card content -->
...
<section class="instructions-wrapper">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-12">
                <div class="instruction">
                    <button type="button" class="btn btn-lg btn-rounded purple-gradient"><i class="fas fa-search fa-2x"
                            aria-hidden="true"></i></button>
        ...
        <div id="carousel-testimonial" class="carousel slide testimonial-carousel" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div>
                    ...
                    <!-- Controls -->
                    <a class="carousel-control-prev left carousel-control" href="#carousel-testimonial" role="button"
                        data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next right carousel-control" href="#carousel-testimonial" role="button"
                        data-slide="next">
