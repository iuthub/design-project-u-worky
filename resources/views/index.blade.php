    ...
    <section class="categories-wrapper">
        <div class="container">
            ...
            <div class="col-xl col-lg-6 col-md-6 col-12">
                ...
                <div class="card">
                    ...
                    <h1><i class="icon-job-it-developers"></i></h1>
                    <h6 class="card-title">
                        <strong><a href="#">IT &amp; Computer</a></strong>
                    </h6>
                    <p>( 10 jobs )</p>
                    </div>
                </div>
            ...
            <div class="col-xl col-lg-6 col-md-6 col-12">
                ...
                <div class="card">
                    <div class="text-white text-center card-content">
                    <h1><i class="icon-job-business-financial"></i></h1>
                    <h6 class="card-title">
                        <strong><a href="#">Finance</a></strong>
                    </h6>
                    <p>( 8 jobs )</p>
                    </div>
                </div>
            ...
            <div class="col-xl col-lg-6 col-md-6 col-12">
                ...
                <div class="card">
                    <div class="text-white text-center card-content">
                    <h1><i class="icon-job-design-media"></i></h1>
                    <h6 class="card-title">
                        <strong><a href="#">Arts, Media, Design</a></strong>
                    </h6>
                    <p>( 2 jobs )</p>
                    </div>
                </div>
            ...
            <div class="col-xl col-lg-6 col-md-6 col-12">
                ...
                <div class="card">
                    <div class="text-white text-center card-content">
                    <h1><i class="icon-job-education"></i></h1>
                    <h6 class="card-title">
        ...
        <div class="container">
            ...
            <div class="col-md-8 tabs-container">
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#recent-jobs-panel" role="tab"> Recent Jobs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#featured-jobs-panel" role="tab">Featured Jobs</a>
                </li>
                </ul>
            </div>
                        ...
                        <div class="col-lg-6 col-md-6 job">
                            ...
                            <div class="row">
                                ...
                                <div class="card-image">
                                    <img src="{{asset('frontend/img/employer-logo-netco.png')}}" class="img-fluid" alt="">
                                </div>
                                </div>
                                <!--Card image -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-lg-6 col-md-6 job">
                            ...
                            <div class="row">
                                ...
                                <!-- Featured -->
                                <div><img src="{{asset('frontend/img/job-featured.png')}}" alt="" class="featured-icon"></div>
                                <!-- /Featured -->
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                    <i class="fa fas fa-suitcase pr-3 mb-1 blue-text"></i>Turon Telecom<br>
                                    <i class="fas fa-map-marker-alt pr-3 mb-1 red-text"></i>Tashkent, Mustakillik str. 5/1<br>
                                    <i class="fas fa-money-bill pr-3 mb-1 green-text"></i>$2,000 - $2,300<br>
                                    </p>
                                </div>
                                <!-- /Card content -->
                                </div>
        ...
        <div class="container-fluid d-flex justify-content-center">
            ...
            <div class="row">
                ...
                <div class="card">
                    <a href="">
                    <img class="card-img-top" src="{{asset('frontend/img/employer-logo-turon.png')}}" alt="Card image cap">
                    </a>
                    <div class="card-body">
                    <!-- Title -->
                    ...
                    <p class="card-text">
                        ...
                        <i class="fas fa-map-marker-alt pr-3 mb-2 red-text"></i>Tashkent, Mustakillik str. 5/1<br>
                    </p>
                    <!-- Button -->
        ...
        <div class="container">
            ...
            <div class="col-xl-3 col-lg-3 col-md-12">
                ...
                <button type="button" class="btn btn-lg btn-rounded aqua-gradient"><i class="fas fa-users fa-2x" aria-hidden="true"></i></button>
                <h3 class="instruction-title">Register an account</h3>
                <hr>
                <p class="instruction-desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id assumenda quidem sequi nostrum illum rerum, nulla recusandae?</p>
                </div>
            </div>

            <div class="col-xl-3 col-lg-3 col-md-12">
                <div class="instruction">
                <button type="button" class="btn btn-lg btn-rounded purple-gradient"><i class="fas fa-search fa-2x" aria-hidden="true"></i></button>
            ...
            <div class="col-xl-3 col-lg-3 col-md-12">
                <div class="instruction">
                <button type="button" class="btn btn-lg btn-rounded peach-gradient"><i class="fas fa-location-arrow fa-2x" aria-hidden="true"></i></button>
        ...
        <div class="container-fluid">
            ...
            <div id="register-employer" class="col-xl-6 col-lg-6 col-md-12">
                ...
                <div>
                    <p class="register-desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id assumenda quidem sequi nostrum illum rerum, nulla recusandae?</p>
                </div>
                <div>
                    <button type="button" class="btn btn-lg btn-rounded btn-primary"><i class="fas fa-user pr-4" aria-hidden="true"></i>Register as employer</button>
                </div>
                </div>
            </div>
            ...
            <div id="register-candidate" class="col-xl-6 col-lg-6 col-md-12">
                ...
                <div>
                    <button type="button" class="btn btn-lg btn-rounded btn-white-border blue-text"><i class="fas fa-user pr-4" aria-hidden="true"></i>Register as candidate</button>
                </div>
                </div>
            </div>
            </div>
        ...
        <div id="carousel-testimonial" class="carousel slide testimonial-carousel" data-ride="carousel">
            ...
            <!-- Controls -->
            <a class="carousel-control-prev left carousel-control" href="#carousel-testimonial" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next right carousel-control" href="#carousel-testimonial" role="button" data-slide="next">
